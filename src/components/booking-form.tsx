        ...
        <div className="bg-white shadow-sm">
          <div className="px-6 py-8">
            <div className="flex flex-col items-center space-y-2 mb-6">
              ...
              <a
                href="/booking-status"
                className="text-lg text-pink-600 hover:text-pink-800 font-medium"
              >
                البحث عن حالة الحجز
              </a>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              {/* Service Selection */}
              <div>
                <label htmlFor="service" className="block text-lg font-medium text-pink-900 mb-2">
                  اختر الخدمة
                </label>
                <select
                  id="service"
                  ...
                  className="w-full rounded-xl border-pink-200 shadow-sm focus:border-pink-500 focus:ring-pink-500 text-lg bg-white py-3"
                >
              ...
              {selectedServices.length > 0 && (
                <div className="bg-pink-50 p-4 rounded-xl border-2 border-pink-100">
                  <h3 className="text-lg font-medium text-pink-900 mb-3">الخدمات المختارة</h3>
                  <ul className="space-y-3">
                    {selectedServices.map((service) => (
                      <li key={service.id} className="flex justify-between items-center text-lg bg-white p-3 rounded-lg">
              ...
              {/* Date Selection */}
              <div>
                <label htmlFor="date" className="block text-lg font-medium text-pink-900 mb-2">
                  اختر التاريخ
                </label>
                <div className="relative">
                  <Calendar className="absolute left-3 top-1/2 transform -translate-y-1/2 h-6 w-6 text-pink-400" />
                  <input
                    type="date"
                    id="date"
                    value={selectedDate}
                    ...
                    className="w-full rounded-xl border-pink-200 shadow-sm focus:border-pink-500 focus:ring-pink-500 pl-12 text-lg bg-white py-3"
                  />
                </div>
              </div>
              ...
              {/* Time Selection */}
              <div>
                <label htmlFor="time" className="block text-lg font-medium text-pink-900 mb-2">
                  اختر الوقت
                </label>
                <div className="relative">
                  <Clock className="absolute left-3 top-1/2 transform -translate-y-1/2 h-6 w-6 text-pink-400" />
                  <select
                    id="time"
                    value={selectedTime}
              ...
              <div className="space-y-4">
                <div>
                  <label htmlFor="name" className="block text-lg font-medium text-pink-900 mb-2">
                    الاسم
                  </label>
                  <div className="relative">
                    <User className="absolute left-3 top-1/2 transform -translate-y-1/2 h-6 w-6 text-pink-400" />
                    <input
                      type="text"
                      id="name"
                      value={name}
                ...
                <div>
                  <label htmlFor="phone" className="block text-lg font-medium text-pink-900 mb-2">
                    رقم الهاتف <span className="text-red-500">*</span>
                  </label>
                  <div className="relative">
                    <Phone className="absolute left-3 top-1/2 transform -translate-y-1/2 h-6 w-6 text-pink-400" />
                    <input
                      type="tel"
                      id="phone"
                      value={phone}
                ...
                <div>
                  <label htmlFor="email" className="block text-lg font-medium text-pink-900 mb-2">
                    البريد الإلكتروني <span className="text-red-500">*</span>
                  </label>
                  <div className="relative">
                    <Mail className="absolute left-3 top-1/2 transform -translate-y-1/2 h-6 w-6 text-pink-400" />
                    <input
                      type="email"
                      id="email"
                      value={email}
                ...
                <div>
                  <label htmlFor="notes" className="block text-lg font-medium text-pink-900 mb-2">
                    ملاحظات (اختياري)
                  </label>
                  <div className="relative">
                    <MessageSquare className="absolute left-3 top-3 h-6 w-6 text-pink-400" />
                    <textarea
                      id="notes"
                      value={notes}
              ...
              {/* Error Message */}
              {error && (
                <div className="bg-red-50 border-2 border-red-200 text-red-700 px-4 py-3 rounded-xl text-lg" role="alert">
              ...
              <div className="pt-3">
                <button
                  ...
                  className={`w-full py-4 px-4 border border-transparent rounded-xl shadow-sm text-lg font-medium text-white ${
              ...
              <div className="mt-6 pt-4 border-t-2 border-pink-100">
                <a
                  href="/booking-status"
                  className="w-full py-4 px-4 border-2 border-pink-500 rounded-xl shadow-sm text-lg font-medium text-pink-600 hover:bg-pink-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500 flex items-center justify-center"
                >
